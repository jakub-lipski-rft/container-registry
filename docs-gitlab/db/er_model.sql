...
CREATE INDEX ix_manifest_configurations_manifest_id ON public.configurations
	USING btree
	(
	  manifest_id
	);
...
CREATE INDEX ix_manifest_configurations_blob_id ON public.configurations
	USING btree
	(
	  blob_id
	);
...
-- ALTER TABLE public.configurations DROP CONSTRAINT IF EXISTS fk_manifest_configurations_manifest_id_manifests CASCADE;
ALTER TABLE public.configurations ADD CONSTRAINT fk_manifest_configurations_manifest_id_manifests FOREIGN KEY (manifest_id)
REFERENCES public.manifests (id) MATCH FULL
ON DELETE CASCADE ON UPDATE NO ACTION;
-- ddl-end --

-- object: fk_manifest_configurations_blob_id_blobs | type: CONSTRAINT --
-- ALTER TABLE public.configurations DROP CONSTRAINT IF EXISTS fk_manifest_configurations_blob_id_blobs CASCADE;
ALTER TABLE public.configurations ADD CONSTRAINT fk_manifest_configurations_blob_id_blobs FOREIGN KEY (blob_id)
