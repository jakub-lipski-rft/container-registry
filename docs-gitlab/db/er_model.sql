...
ALTER TABLE public.manifest_list_items ADD CONSTRAINT fk_manifest_list_items_manifest_id_manifests FOREIGN KEY (manifest_id)
REFERENCES public.manifests (id) MATCH SIMPLE
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --
...
ALTER TABLE public.manifest_list_items ADD CONSTRAINT fk_manifest_list_items_manifest_list_id_manifest_lists FOREIGN KEY (manifest_list_id)
