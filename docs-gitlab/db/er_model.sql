...
-- object: public.configurations | type: TABLE --
...
-- object: public.manifest_references | type: TABLE --
...
-- ddl-end --
-- ALTER TABLE public.manifest_references OWNER TO postgres;
-- ddl-end --
...
-- object: ix_manifest_references_parent_id | type: INDEX --
-- DROP INDEX IF EXISTS public.ix_manifest_references_parent_id CASCADE;
CREATE INDEX ix_manifest_references_parent_id ON public.manifest_references
	USING btree
	(
	  parent_id
	);
...
-- object: ix_manifest_references_child_id | type: INDEX --
-- DROP INDEX IF EXISTS public.ix_manifest_references_child_id CASCADE;
CREATE INDEX ix_manifest_references_child_id ON public.manifest_references
	USING btree
	(
	  child_id
	);
...
-- object: ix_configurations_blob_id | type: INDEX --
-- DROP INDEX IF EXISTS public.ix_configurations_blob_id CASCADE;
CREATE INDEX ix_configurations_blob_id ON public.configurations
	USING btree
	(
	  blob_id
	);
...
-- object: ix_manifests_configuration_id | type: INDEX --
-- DROP INDEX IF EXISTS public.ix_manifests_configuration_id CASCADE;
CREATE INDEX ix_manifests_configuration_id ON public.manifests
	USING btree
	(
	  configuration_id
	);
...
-- object: fk_configurations_blob_id_blobs | type: CONSTRAINT --
-- ALTER TABLE public.configurations DROP CONSTRAINT IF EXISTS fk_configurations_blob_id_blobs CASCADE;
ALTER TABLE public.configurations ADD CONSTRAINT fk_configurations_blob_id_blobs FOREIGN KEY (blob_id)
REFERENCES public.blobs (id) MATCH FULL
ON DELETE CASCADE ON UPDATE NO ACTION;
-- ddl-end --

-- object: fk_manifests_configuration_id_configurations | type: CONSTRAINT --
-- ALTER TABLE public.manifests DROP CONSTRAINT IF EXISTS fk_manifests_configuration_id_configurations CASCADE;
ALTER TABLE public.manifests ADD CONSTRAINT fk_manifests_configuration_id_configurations FOREIGN KEY (configuration_id)
REFERENCES public.configurations (id) MATCH FULL
ON DELETE CASCADE ON UPDATE NO ACTION;
-- ddl-end --
...
-- object: fk_manifest_references_parent_id_manifests | type: CONSTRAINT --
-- ALTER TABLE public.manifest_references DROP CONSTRAINT IF EXISTS fk_manifest_references_parent_id_manifests CASCADE;
ALTER TABLE public.manifest_references ADD CONSTRAINT fk_manifest_references_parent_id_manifests FOREIGN KEY (parent_id)
REFERENCES public.manifests (id) MATCH SIMPLE
ON DELETE CASCADE ON UPDATE NO ACTION;
-- ddl-end --

-- object: fk_manifest_references_child_id_manifests | type: CONSTRAINT --
-- ALTER TABLE public.manifest_references DROP CONSTRAINT IF EXISTS fk_manifest_references_child_id_manifests CASCADE;
ALTER TABLE public.manifest_references ADD CONSTRAINT fk_manifest_references_child_id_manifests FOREIGN KEY (child_id)
