...
-- object: fk_manifest_configurations_manifest_id | type: CONSTRAINT --
-- ALTER TABLE public.manifest_configurations DROP CONSTRAINT IF EXISTS fk_manifest_configurations_manifest_id CASCADE;
ALTER TABLE public.manifest_configurations ADD CONSTRAINT fk_manifest_configurations_manifest_id FOREIGN KEY (manifest_id)
