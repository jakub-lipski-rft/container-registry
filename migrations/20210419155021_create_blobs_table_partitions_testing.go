...
func init() {
	m := &Migration{
		Migration: &migrate.Migration{
			Id: "20210419155021_create_blobs_table_partitions_testing",
			Up: []string{
			...
			Down: []string{
				...
				"CREATE TABLE IF NOT EXISTS partitions.blobs_default PARTITION OF public.blobs FOR VALUES WITH (MODULUS 1, REMAINDER 0)",
			},
		},
	}
