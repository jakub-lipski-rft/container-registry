	...
	m := &migrate.Migration{
		...
		Up: []string{
			`CREATE TABLE IF NOT EXISTS tags (
                ...
                CONSTRAINT fk_tags_manifest_list_id_manifest_lists FOREIGN KEY (manifest_list_id) REFERENCES manifest_lists (id) ON DELETE CASCADE,
		...
		Down: []string{
			"DROP INDEX IF EXISTS ix_tags_manifest_list_id CASCADE",
