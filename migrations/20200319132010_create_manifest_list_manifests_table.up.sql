...
(
    ...
    CONSTRAINT fk_manifest_list_manifests_manifest_list_id_manifest_lists FOREIGN KEY (manifest_list_id)
        REFERENCES manifest_lists (id) ON DELETE CASCADE,
    CONSTRAINT fk_manifest_list_manifests_manifest_id_manifests FOREIGN KEY (manifest_id)
