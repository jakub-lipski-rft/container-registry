...
func init() {
	m := &Migration{
		Migration: &migrate.Migration{
			Id: "20210419155144_create_tags_table_partitions_testing",
			Up: []string{
			...
			Down: []string{
				...
				"CREATE TABLE IF NOT EXISTS partitions.tags_default PARTITION OF public.tags FOR VALUES WITH (MODULUS 1, REMAINDER 0)",
			},
		},
	}
